...
/**
  ...
  public static void main {
    ...
    Item backpack = new Item("Boba's Backpack", 1, 2, "There's a photo inside the front pocket of the backpack! Apart from that, the backpack appears to be empty.", false);
